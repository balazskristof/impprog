/*
5. Írj így programot, ami skalárszorzást végez két tetszőleges hosszú vektoron!
...
int main()
{
	...
	/* allokálás
	   allokáljuk a két vektort calloc-al
	   a calloc elé zárójelbe írjuk az elemek típusát (egyezik a változó típusával) */
